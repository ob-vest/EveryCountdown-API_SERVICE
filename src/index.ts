...
app.get("/search", async (req, res) => {
  ...
  try {
    const { rows } = await pool.query(
      `SELECT'movie' AS type,headline,subheadline FROM movie WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'tv' AS type,headline,subheadline FROM tv WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'anime' AS type,headline,subheadline FROM anime WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'tech' AS type,headline,subheadline FROM tech WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'game' AS type,headline,subheadline FROM game WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'politics' AS type,headline,subheadline FROM politics WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'sport' AS type,headline,subheadline FROM sport WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'holiday' AS type,headline,subheadline FROM holiday WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1);`,
      [`%${search}%`]
    );
    res.send(rows);
  } catch (error) {
