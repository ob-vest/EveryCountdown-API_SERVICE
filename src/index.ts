...
app.get("/search", async (req, res) => {
  ...
  try {
    const { rows } = await pool.query(
      `SELECT'movie' AS table_name,headline,subheadline FROM movie WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'tv' AS table_name,headline,subheadline FROM tv WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'anime' AS table_name,headline,subheadline FROM anime WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'tech' AS table_name,headline,subheadline FROM tech WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'game' AS table_name,headline,subheadline FROM game WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'politics' AS table_name,headline,subheadline FROM politics WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'sport' AS table_name,headline,subheadline FROM sport WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1)UNION SELECT'holiday' AS table_name,headline,subheadline FROM holiday WHERE LOWER(headline)LIKE LOWER($1)OR LOWER(subheadline)LIKE LOWER($1);`,
      [`%${search}%`]
    );
    res.send(rows);
  } catch (error) {
